  ...
  return (
    <footer className="bg-gray-100 pt-16 pb-6">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        ...
        <a href="https://wa.me/917034111687"
          target="_blank"
          rel="noopener noreferrer"
          className="w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-110"
          aria-label="WhatsApp"
        >
          <svg
