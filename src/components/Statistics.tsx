...
const Statistics = () => {
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col md:flex-row items-center justify-center gap-y-6 gap-x-12">

      {/* Stat 1 */}
      <div className="flex items-center justify-center gap-4 mb-2 mr-6 md:mb-0">
